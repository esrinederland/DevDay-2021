...
namespace Metadata.Pages
{
    internal class ContactManagerSidebarLabel : ISidebarLabel
    {
        string ISidebarLabel.SidebarLabel
        {
            get
            {
                return ContactManagerSidebarLabel.SidebarLabel;
            }
        }
        ...
        public static string SidebarLabel
        {
            get
            {
                return Metadata.Properties.Resources.CFG_LBL_CONTACT_MGR;
            }
        }
    }
    /// <summary>
    ...
    internal partial class MTK_ContactManager : EditorPage
    {
        ...
        public void OnUnCheck(object sender, RoutedEventArgs e)
        {
            ...
            if (false == check && "external".Equals(tagNode.InnerText))
            {
                ...
                // show dialog
                MessageBoxResult result = ArcGIS.Desktop.Framework.Dialogs.MessageBox.Show(Metadata.Properties.Resources.LBL_CM_Confirm, Metadata.Properties.Resources.LBL_CM_ConfirmTitle, button, icon);
